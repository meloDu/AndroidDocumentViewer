package com.hanlyjiang.library.fileviewer.demos.utils;
...
/**
 * @author hanlyjiang on 2018/5/11-19:48.
 * @version 1.0
 */
...
public class ZipUtils {
    ...
    public static boolean UnZipFolder(String zipFileString, String outPathString) throws Exception {
        String outPutDir = outPathString;
        ...
        while ((zipEntry = inZip.getNextEntry()) != null) {
            ...
            String pathname = outPutDir + szName;
            if (zipEntry.isDirectory()) {
                ...
                if (!file.exists()) {
                    Log.e(TAG, "Create the file:" + pathname);
                    boolean mkdirs = file.getParentFile().mkdirs();
                    if (!mkdirs) {
                        Log.e(TAG, "目录 " + file.getParent() + " 创建失败");
                    }
                    file.createNewFile();
                }
                // 获取文件的输出流
